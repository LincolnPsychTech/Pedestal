function repVar = repVariables()
noVariables = inputdlg('Number of repeated measures factors...'); %number of variables
...
if noVariables == 0 | isempty(noVariables) | ~exist('noVariables')
    ...
    for variable = 1:noVariables
        ...
        varType{variable} = 'Repeated Measures';
    end
end
...
%Package output
repVar = struct('FactorName', varNames, 'Levels', conditions);